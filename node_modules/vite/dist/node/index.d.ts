...
export declare interface ESBuildOptions extends TransformOptions {
...
export declare function getDepHash(root: string, mode: string, configFile: string | undefined): string;
...
export declare function resolvePackageEntry(id: string, { resolvedImports, dir, data }: PackageData, isProduction?: boolean): string | undefined;
