...
require('fs');
require('path');
var build = require('./chunks/dep-b51e3b62.js');
require('tty');
require('util');
require('net');
...
cli
    ...
    // is ok here
    const { createServer } = await Promise.resolve().then(function () { return require('./chunks/dep-b51e3b62.js'); }).then(function (n) { return n.index$1; });
    try {
...
cli
    ...
    .option('-m, --mode <mode>', `[string] set env mode`)
    .action(async (root, options) => {
    const { build: build$1 } = await Promise.resolve().then(function () { return require('./chunks/dep-b51e3b62.js'); }).then(function (n) { return n.build$1; });
    try {
        await build$1({
            root,
            mode: options.mode,
...
cli
    ...
    .option('--force', `[boolean] force the optimizer to ignore the cache and re-bundle`)
    .action(async (root, options) => {
    const { optimizeDeps } = await Promise.resolve().then(function () { return require('./chunks/dep-b51e3b62.js'); }).then(function (n) { return n.index; });
    try {
